      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-6 lg:space-x-8">
            <Link to="/" className={`nav-link flex items-center gap-1.5 ${location.pathname === '/' ? 'text-primary' : ''}`}>
              <img src="/icons/home.png" alt="" className="w-5 h-5 opacity-80 group-hover:opacity-100 transition-opacity"/>
              Home
            </Link>
            <Link to="/casinos" className={`nav-link flex items-center gap-1.5 ${location.pathname === '/casinos' ? 'text-primary' : ''}`}>
              <img src="/icons/casinos.png" alt="" className="w-5 h-5 opacity-80 group-hover:opacity-100 transition-opacity"/>
              Casinos
            </Link>
            <Link to="/events" className={`nav-link flex items-center gap-1.5 ${location.pathname === '/events' ? 'text-primary' : ''}`}>
              <img src="/icons/events.png" alt="" className="w-5 h-5 opacity-80 group-hover:opacity-100 transition-opacity"/>
              Events
            </Link>
            <Link to="/cash-games" className={`nav-link flex items-center gap-1.5 ${location.pathname === '/cash-games' ? 'text-primary' : ''}`}>
              <img src="/icons/cashgames.png" alt="" className="w-5 h-5 opacity-80 group-hover:opacity-100 transition-opacity"/>
              Live Cash Games
            </Link>
        ...
        >
          <div className="flex flex-col space-y-0.5 items-start px-2">
            ...
            >
              <img src="/icons/home.png" alt="" className="w-6 h-6"/>
              Home
            </Link>
            <Link 
              to="/casinos" 
              ...
              onClick={() => setIsMenuOpen(false)}
            >
              <img src="/icons/casinos.png" alt="" className="w-6 h-6"/>
              Casinos
            </Link>
            <Link 
              to="/events" 
              ...
              onClick={() => setIsMenuOpen(false)}
            >
              <img src="/icons/events.png" alt="" className="w-6 h-6"/>
              Events
            </Link>
            <Link 
              to="/cash-games" 
              ...
              onClick={() => setIsMenuOpen(false)}
            >
              <img src="/icons/cashgames.png" alt="" className="w-6 h-6"/>
              Live Cash Games
            </Link>
