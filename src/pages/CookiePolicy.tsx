      ...
      <main className="pt-24 pb-12 min-h-screen bg-background text-foreground">
        <div className="container mx-auto px-4 max-w-3xl animate-fade-in">
          ...
          <div className="prose prose-invert max-w-none prose-headings:text-primary prose-a:text-primary prose-p:mb-6 prose-li:mb-3 space-y-8">
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-primary">2. Why do we use cookies?</h2>
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-primary">3. What types of cookies do we use?</h2>
              <ul className="list-disc pl-6 space-y-4 mt-4">
                <li>
                  <span className="font-medium text-primary">Essential website cookies:</span> These cookies are strictly necessary to provide you with services available through our Website and to use some of its features, such as access to secure areas.
                </li>
                <li>
                  <span className="font-medium text-primary">Performance and functionality cookies:</span> These cookies are used to enhance the performance and functionality of our Website but are non-essential to their use. However, without these cookies, certain functionality may become unavailable.
                </li>
                <li>
                  <span className="font-medium text-primary">Analytics and customization cookies:</span> These cookies collect information that is used either in aggregate form to help us understand how our Website is being used or how effective our marketing campaigns are, or to help us customize our Website for you. For example, we use Google Analytics (see below).
                </li>
              </ul>
            </div>

            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-primary">4. Google Analytics</h2>
              ...
              <p className="mt-4">For more information on how Google collects and processes data, visit <a href="https://policies.google.com/technologies/partner-sites" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Google's Privacy & Terms</a>.</p>
              <p className="mt-4">You can prevent Google Analytics from recognizing you on return visits to this Website by disabling cookies on your browser or by opting out via our cookie consent banner.</p>
            </div>

            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-primary">5. How can I control cookies?</h2>
              ...
              <p className="mt-4">The Cookie Consent Banner allows you to accept or decline non-essential cookies. You can also set or amend your web browser controls to accept or refuse cookies. If you choose to reject cookies, you may still use our Website though your access to some functionality and areas of our Website may be restricted.</p>
            </div>

            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-primary">6. Changes to this Cookie Policy</h2>
              <p>We may update this Cookie Policy from time to time in order to reflect, for example, changes to the cookies we use or for other operational, legal or regulatory reasons. Please therefore re-visit this Cookie Policy regularly to stay informed about our use of cookies and related technologies.</p>
            </div>

            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-primary">7. Where can you get further information?</h2>
              <p>If you have any questions about our use of cookies or other technologies, please email us at <a href="mailto:info@pokerlist.com" className="text-primary hover:underline">info@pokerlist.com</a>.</p>
              <p className="mt-4">For more information about how we use, store and keep your personal data secure, see our <Link to="/privacy-policy" className="text-primary hover:underline">Privacy Policy</Link>.</p>
            </div>
          </div>
        </div>
      </main>
